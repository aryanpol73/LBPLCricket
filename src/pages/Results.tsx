        ...
        <div className="relative bg-gradient-to-br from-[hsl(220,25%,12%)] via-[hsl(220,30%,15%)] to-[hsl(220,25%,10%)] rounded-3xl p-8 shadow-premium border-2 border-[hsl(45,90%,50%)]/30">
          ...
          <div className="relative space-y-12">
            {results.length > 0 ? (
              ...
              <Card className="bg-[hsl(220,25%,18%)] backdrop-blur-sm border-2 border-[hsl(45,70%,55%)]/40 shadow-gold-soft">
                <div className="p-12 text-center">
                  <Award className="mx-auto text-[hsl(45,90%,55%)] mb-4" size={48} />
                  <p className="text-gray-300 text-lg">No completed matches yet</p>
                </div>
              </Card>
            )}
          </div>
